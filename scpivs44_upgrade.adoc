...
CAUTION: Before upgrading, verify that your environment meets the system requirements. Refer to link:scpivs44_deployment_planning_and_requirements.html[SnapCenter Plug-in for VMware vSphere Deployment Planning and Requirements] for details.
