...
CAUTION: Before performing your upgrade, you must verify that the system meets the required configuration requirements. Refer to link:scpivs44_deployment_planning_and_requirements.html[SnapCenter Plug-in for VMware vSphere Deployment Planning and Requirements] for details.
...
For the latest information about supported versions, refer to link:https://imt.netapp.com/matrix/imt.jsp?components=134348;&solution=1517&isHWU&src=IMT[NetApp Interoperability Matrix Tool (IMT)^].
...
.. Log in to the link:https://mysupport.netapp.com/products/index.html[NetApp Support site^].
